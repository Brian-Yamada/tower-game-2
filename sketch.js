...
function setup() {
 ...
 box1=new Box(330,200,50,50);
 box2=new Box(350,200,50,50);
 box3=new Box(400,200,50,50);
 box4=new Box(365,157,50,50);
 box5=new Box(375,153,50,50);
 box6=new Box(350,102,50,50);
 box7=new Box(530,552,50,50);
 box8=new Box(550,530,50,50);
 box9=new Box(600,552,50,50);
 box10=new Box(525,500,50,50);
 box11=new Box(275,530,50,50);
...
sling=new SlingShot(polygon.body,{x:150,y:300});
